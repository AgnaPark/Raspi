...
picam2.start()
time.sleep(2)
picam2.capture_file("Images/CAR0_0.jpg")
picam2.capture_file("Images/CAR0_1.jpg")
picam2.capture_file("Images/CAR0_2.jpg")
picam2.capture_file("Images/CAR0_3.jpg")
picam2.capture_file("Images/CAR0_4.jpg")
picam2.capture_file("Images/CAR0_5.jpg")
picam2.capture_file("Images/CAR0_6.jpg")
picam2.capture_file("Images/CAR0_7.jpg")
picam2.capture_file("Images/CAR0_8.jpg")
picam2.capture_file("Images/CAR0_9.jpg")
picam2.stop_preview()
picam2.close()
'''
valid_plates = []
...
for i in range(10):
    picture = "Images/CAR0_"+str(i)+".jpg"
    print(picture)
